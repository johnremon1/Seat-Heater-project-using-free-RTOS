...
#define ADC0_ACTSS_REG            (*((volatile uint32 *)0x40038000))//ADC0 Active Sample Sequencer Register
#define ADC0_RIS_REG              (*((volatile uint32 *)0x40038004))//ADC0 ADC Raw Interrupt Status Register
#define ADC0_IM_REG               (*((volatile uint32 *)0x40038008))//ADC0 ADC Interrupt Mask Register
#define ADC0_ISC_REG              (*((volatile uint32 *)0x4003800C))//ADC0 Interrupt Status and Clear Register
#define ADC0_OSTAT_REG            (*((volatile uint32 *)0x40038010))//ADC0 Overflow Status Register
#define ADC0_EMUX_REG             (*((volatile uint32 *)0x40038014))//ADC0 Event Multiplexer Select Register
#define ADC0_TSSEL_REG            (*((volatile uint32 *)0x4003801C))//ADC0 Trigger Source Select Register
#define ADC0_SSPRI_REG            (*((volatile uint32 *)0x40038020))//ADC0 Sample Sequencer Priority Register
#define ADC0_PSSI_REG             (*((volatile uint32 *)0x40038028))//ADC0 Processor Sample Sequence Initiate Register
#define ADC0_CTL_REG              (*((volatile uint32 *)0x40038038))//ADC0 Control Register
#define ADC0_SSMUX0_REG           (*((volatile uint32 *)0x40038040))//ADC0 Sample Sequence Input Multiplexer Select 0 Register
#define ADC0_SSCTL0_REG           (*((volatile uint32 *)0x40038044))//ADC0 Sample Sequence Control 0 Register
#define ADC0_SSFIFO0_REG          (*((volatile uint32 *)0x40038048))//ADC0 Sample Sequence Result FIFO 0 Register
#define ADC0_SSFIFO1_REG          (*((volatile uint32 *)0x40038068))//ADC0 Sample Sequence Result FIFO 1 Register
#define ADC0_SSFIFO2_REG          (*((volatile uint32 *)0x40038088))//ADC0 Sample Sequence Result FIFO 2 Register
#define ADC0_SSFIFO3_REG          (*((volatile uint32 *)0x400380A8))//ADC0 Sample Sequence Result FIFO 3 Register
#define ADC0_SSFSTAT0_REG         (*((volatile uint32 *)0x4003804C))//ADC0 Sample Sequence FIFO 0 Status Register
#define ADC0_SSFSTAT1_REG         (*((volatile uint32 *)0x4003806C))//ADC0 Sample Sequence FIFO 1 Status Register
#define ADC0_SSFSTAT2_REG         (*((volatile uint32 *)0x4003808C))//ADC0 Sample Sequence FIFO 2 Status Register
#define ADC0_SSFSTAT3_REG         (*((volatile uint32 *)0x400380AC))//ADC0 Sample Sequence FIFO 3 Status Register
#define ADC0_PC_REG               (*((volatile uint32 *)0x40038FC4))//ADC0 Peripheral Configuration Register
#define ADC0_CC_REG               (*((volatile uint32 *)0x40038FC8))//ADC0 Clock Configuration Register
...
#define ADC1_ACTSS_REG            (*((volatile uint32 *)0x40039000))//ADC1 Active Sample Sequencer Register
#define ADC1_RIS_REG              (*((volatile uint32 *)0x40039004))//ADC1 ADC Raw Interrupt Status Register
#define ADC1_IM_REG               (*((volatile uint32 *)0x40039008))//ADC1 ADC Interrupt Mask Register
#define ADC1_ISC_REG              (*((volatile uint32 *)0x4003900C))//ADC1 Interrupt Status and Clear Register
#define ADC1_OSTAT_REG            (*((volatile uint32 *)0x40039010))//ADC1 Overflow Status Register
#define ADC1_EMUX_REG             (*((volatile uint32 *)0x40039014))//ADC1 Event Multiplexer Select Register
#define ADC1_TSSEL_REG            (*((volatile uint32 *)0x4003901C))//ADC1 Trigger Source Select Register
#define ADC1_SSPRI_REG            (*((volatile uint32 *)0x40039020))//ADC1 Sample Sequencer Priority Register
#define ADC1_PSSI_REG             (*((volatile uint32 *)0x40039028))//ADC1 Processor Sample Sequence Initiate Register
#define ADC1_CTL_REG              (*((volatile uint32 *)0x40039038))//ADC1 Control Register
#define ADC1_SSMUX0_REG           (*((volatile uint32 *)0x40039040))//ADC1 Sample Sequence Input Multiplexer Select 0 Register
#define ADC1_SSCTL0_REG           (*((volatile uint32 *)0x40039044))//ADC1 Sample Sequence Control 0 Register
#define ADC1_SSFIFO0_REG          (*((volatile uint32 *)0x40039048))//ADC1 Sample Sequence Result FIFO 0 Register
#define ADC1_SSFIFO1_REG          (*((volatile uint32 *)0x40039068))//ADC1 Sample Sequence Result FIFO 1 Register
#define ADC1_SSFIFO2_REG          (*((volatile uint32 *)0x40039088))//ADC1 Sample Sequence Result FIFO 2 Register
#define ADC1_SSFIFO3_REG          (*((volatile uint32 *)0x400390A8))//ADC1 Sample Sequence Result FIFO 3 Register
#define ADC1_SSFSTAT0_REG         (*((volatile uint32 *)0x4003904C))//ADC1 Sample Sequence FIFO 0 Status Register
#define ADC1_SSFSTAT1_REG         (*((volatile uint32 *)0x4003906C))//ADC1 Sample Sequence FIFO 1 Status Register
#define ADC1_SSFSTAT2_REG         (*((volatile uint32 *)0x4003908C))//ADC1 Sample Sequence FIFO 2 Status Register
#define ADC1_SSFSTAT3_REG         (*((volatile uint32 *)0x400390AC))//ADC1 Sample Sequence FIFO 3 Status Register
#define ADC1_PC_REG               (*((volatile uint32 *)0x40039FC4))//ADC1 Peripheral Configuration Register
#define ADC1_CC_REG               (*((volatile uint32 *)0x40039FC8))//ADC1 Clock Configuration Register
