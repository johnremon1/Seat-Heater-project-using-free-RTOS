...
#define configTIMER_QUEUE_LENGTH                                (10U)//this is the size in words of the timer command queue
#define INCLUDE_xTimerPendFunctionCall                           (1U)


#define configUSE_APPLICATION_TASK_TAG         1
#define INCLUDE_vTaskDelete                    1
#define RUNTIME_MEASUREMENTS_TASK_PERIODICITY     100
